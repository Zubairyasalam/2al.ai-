        ...
        >
          ...
          <div className="w-1/2 bg-indigo-900 text-white p-8 relative overflow-hidden flex flex-col justify-between h-[360px]">
            ...
            <div className="space-y-3 relative z-10">
              <div className="flex justify-between items-center text-[9px] font-black text-indigo-200 tracking-widest uppercase border-b border-white/10 pb-2">
            ...
            <div className="space-y-3 pt-4 border-t border-white/10 relative z-10">
              <span className="block text-[9px] font-black text-indigo-200 tracking-widest uppercase">
                On-Demand Webinar
              </span>
